...
<reference>
@/Users/T.Finizzi/repo/FineTuning-Lineage/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/Users/T.Finizzi/repo/FineTuning-Lineage/.claude/get-shit-done/references/user-profiling.md` to load:
