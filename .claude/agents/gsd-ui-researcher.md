...
Use template from `/Users/T.Finizzi/repo/FineTuning-Lineage/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/Users/T.Finizzi/repo/FineTuning-Lineage/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/Users/T.Finizzi/repo/FineTuning-Lineage/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
