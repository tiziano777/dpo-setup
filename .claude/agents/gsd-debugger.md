...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Users/T.Finizzi/repo/FineTuning-Lineage/.claude
                  → checks /Users/T.Finizzi/repo/FineTuning-Lineage/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/T.Finizzi/repo/FineTuning-Lineage/.claude/get-shit-done
                  → writes to /Users/T.Finizzi/repo/FineTuning-Lineage/.claude/get-shit-done/hooks/
...
@/Users/T.Finizzi/repo/FineTuning-Lineage/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/Users/T.Finizzi/repo/FineTuning-Lineage/.claude/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "/Users/T.Finizzi/repo/FineTuning-Lineage/.claude/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/Users/T.Finizzi/repo/FineTuning-Lineage/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/Users/T.Finizzi/repo/FineTuning-Lineage/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
