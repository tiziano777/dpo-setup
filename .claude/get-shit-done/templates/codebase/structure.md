...
- Usage: Reference from command with `@/Users/T.Finizzi/repo/FineTuning-Lineage/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/T.Finizzi/repo/FineTuning-Lineage/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/T.Finizzi/repo/FineTuning-Lineage/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
