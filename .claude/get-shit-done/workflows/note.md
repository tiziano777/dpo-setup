...
- **Global scope**: `/Users/T.Finizzi/repo/FineTuning-Lineage/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/T.Finizzi/repo/FineTuning-Lineage/.claude/notes/`)
...
2. Glob `/Users/T.Finizzi/repo/FineTuning-Lineage/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/T.Finizzi/repo/FineTuning-Lineage/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/T.Finizzi/repo/FineTuning-Lineage/.claude/notes/` — works in any directory
