...
```bash
PHASE_INFO=$(node "/Users/T.Finizzi/repo/FineTuning-Lineage/.claude/get-shit-done/bin/gsd-tools.cjs" find-phase "${PHASE}")
```
...
```bash
PHASE_CHECK=$(node "/Users/T.Finizzi/repo/FineTuning-Lineage/.claude/get-shit-done/bin/gsd-tools.cjs" roadmap get-phase "${PHASE}" --pick found)
...
```bash
PHASE_DIR=$(node "/Users/T.Finizzi/repo/FineTuning-Lineage/.claude/get-shit-done/bin/gsd-tools.cjs" find-phase "${PHASE}" --raw)
```
