...
Intel system is disabled. To activate:
  ...
  node /Users/T.Finizzi/repo/FineTuning-Lineage/.claude/get-shit-done/bin/gsd-tools.cjs config-set intel.enabled true
...
```bash
node /Users/T.Finizzi/repo/FineTuning-Lineage/.claude/get-shit-done/bin/gsd-tools.cjs intel query <term>
```
...
```bash
node /Users/T.Finizzi/repo/FineTuning-Lineage/.claude/get-shit-done/bin/gsd-tools.cjs intel status
```
...
```bash
node /Users/T.Finizzi/repo/FineTuning-Lineage/.claude/get-shit-done/bin/gsd-tools.cjs intel diff
```
...
Project root: ${CWD}
gsd-tools path: /Users/T.Finizzi/repo/FineTuning-Lineage/.claude/get-shit-done/bin/gsd-tools.cjs
